 ...
 * @brief Contains the data model class representing the pair of dice used to play Game of Ur.
 * @version 0.3.2
 * @date 2025-09-12
 * 
 * 
...
/**
 * @ingroup UrGameDataModel
 * @brief The data model used to represent the pair of dice used to play Game of Ur.
 * 
