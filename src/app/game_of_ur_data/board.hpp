 ...
 * @brief Contains the data model class representing the 20-square board for Game of Ur.
 * @version 0.3.2
 * @date 2025-09-12
 * 
 * 
...
/**
 * @ingroup UrGameDataModel
 * @brief The data model class representing the 20-square board for Game of Ur.
 * 
